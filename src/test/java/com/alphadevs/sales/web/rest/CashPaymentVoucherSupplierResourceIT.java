...
public class CashPaymentVoucherSupplierResourceIT {
    ...
    public void createCashPaymentVoucherSupplier() throws Exception {
        ...
        assertThat(testCashPaymentVoucherSupplier.getTransactionAmountDR()).isEqualTo(DEFAULT_TRANSACTION_AMOUNT_DR);
        assertThat(testCashPaymentVoucherSupplier.getTransactionAmountCR()).isEqualTo(DEFAULT_TRANSACTION_AMOUNT_CR);
    }
    ...
    public void checkTransactionAmountDRIsRequired() throws Exception {
        int databaseSizeBeforeTest = cashPaymentVoucherSupplierRepository.findAll().size();
        // set the field null
        cashPaymentVoucherSupplier.setTransactionAmountDR(null);
    ...
    public void checkTransactionAmountCRIsRequired() throws Exception {
        int databaseSizeBeforeTest = cashPaymentVoucherSupplierRepository.findAll().size();
        // set the field null
        cashPaymentVoucherSupplier.setTransactionAmountCR(null);
    ...
    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountDRIsEqualToSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR equals to DEFAULT_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountDR.equals=" + DEFAULT_TRANSACTION_AMOUNT_DR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR equals to UPDATED_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountDR.equals=" + UPDATED_TRANSACTION_AMOUNT_DR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountDRIsNotEqualToSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR not equals to DEFAULT_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountDR.notEquals=" + DEFAULT_TRANSACTION_AMOUNT_DR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR not equals to UPDATED_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountDR.notEquals=" + UPDATED_TRANSACTION_AMOUNT_DR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountDRIsInShouldWork() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR in DEFAULT_TRANSACTION_AMOUNT_DR or UPDATED_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountDR.in=" + DEFAULT_TRANSACTION_AMOUNT_DR + "," + UPDATED_TRANSACTION_AMOUNT_DR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR equals to UPDATED_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountDR.in=" + UPDATED_TRANSACTION_AMOUNT_DR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountDRIsNullOrNotNull() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is not null
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountDR.specified=true");

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is null
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountDR.specified=false");
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountDRIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is greater than or equal to DEFAULT_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountDR.greaterThanOrEqual=" + DEFAULT_TRANSACTION_AMOUNT_DR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is greater than or equal to UPDATED_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountDR.greaterThanOrEqual=" + UPDATED_TRANSACTION_AMOUNT_DR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountDRIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is less than or equal to DEFAULT_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountDR.lessThanOrEqual=" + DEFAULT_TRANSACTION_AMOUNT_DR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is less than or equal to SMALLER_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountDR.lessThanOrEqual=" + SMALLER_TRANSACTION_AMOUNT_DR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountDRIsLessThanSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is less than DEFAULT_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountDR.lessThan=" + DEFAULT_TRANSACTION_AMOUNT_DR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is less than UPDATED_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountDR.lessThan=" + UPDATED_TRANSACTION_AMOUNT_DR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountDRIsGreaterThanSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is greater than DEFAULT_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountDR.greaterThan=" + DEFAULT_TRANSACTION_AMOUNT_DR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountDR is greater than SMALLER_TRANSACTION_AMOUNT_DR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountDR.greaterThan=" + SMALLER_TRANSACTION_AMOUNT_DR);
    }


    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountCRIsEqualToSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR equals to DEFAULT_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountCR.equals=" + DEFAULT_TRANSACTION_AMOUNT_CR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR equals to UPDATED_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountCR.equals=" + UPDATED_TRANSACTION_AMOUNT_CR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountCRIsNotEqualToSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR not equals to DEFAULT_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountCR.notEquals=" + DEFAULT_TRANSACTION_AMOUNT_CR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR not equals to UPDATED_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountCR.notEquals=" + UPDATED_TRANSACTION_AMOUNT_CR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountCRIsInShouldWork() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR in DEFAULT_TRANSACTION_AMOUNT_CR or UPDATED_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountCR.in=" + DEFAULT_TRANSACTION_AMOUNT_CR + "," + UPDATED_TRANSACTION_AMOUNT_CR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR equals to UPDATED_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountCR.in=" + UPDATED_TRANSACTION_AMOUNT_CR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountCRIsNullOrNotNull() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is not null
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountCR.specified=true");

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is null
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountCR.specified=false");
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountCRIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is greater than or equal to DEFAULT_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountCR.greaterThanOrEqual=" + DEFAULT_TRANSACTION_AMOUNT_CR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is greater than or equal to UPDATED_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountCR.greaterThanOrEqual=" + UPDATED_TRANSACTION_AMOUNT_CR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountCRIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is less than or equal to DEFAULT_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountCR.lessThanOrEqual=" + DEFAULT_TRANSACTION_AMOUNT_CR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is less than or equal to SMALLER_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountCR.lessThanOrEqual=" + SMALLER_TRANSACTION_AMOUNT_CR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountCRIsLessThanSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is less than DEFAULT_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountCR.lessThan=" + DEFAULT_TRANSACTION_AMOUNT_CR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is less than UPDATED_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountCR.lessThan=" + UPDATED_TRANSACTION_AMOUNT_CR);
    }

    @Test
    @Transactional
    public void getAllCashPaymentVoucherSuppliersByTransactionAmountCRIsGreaterThanSomething() throws Exception {
        // Initialize the database
        cashPaymentVoucherSupplierRepository.saveAndFlush(cashPaymentVoucherSupplier);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is greater than DEFAULT_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldNotBeFound("transactionAmountCR.greaterThan=" + DEFAULT_TRANSACTION_AMOUNT_CR);

        // Get all the cashPaymentVoucherSupplierList where transactionAmountCR is greater than SMALLER_TRANSACTION_AMOUNT_CR
        defaultCashPaymentVoucherSupplierShouldBeFound("transactionAmountCR.greaterThan=" + SMALLER_TRANSACTION_AMOUNT_CR);
    }
    ...
    public void updateCashPaymentVoucherSupplier() throws Exception {
        ...
        assertThat(testCashPaymentVoucherSupplier.getTransactionAmountDR()).isEqualTo(UPDATED_TRANSACTION_AMOUNT_DR);
        assertThat(testCashPaymentVoucherSupplier.getTransactionAmountCR()).isEqualTo(UPDATED_TRANSACTION_AMOUNT_CR);
    }
