...
public class StockResourceIT {
    ...
    @Test
    @Transactional
    public void getAllStocksByTransactionTypeIsEqualToSomething() throws Exception {
        // Get already existing entity
        TransactionType transactionType = stock.getTransactionType();
        stockRepository.saveAndFlush(stock);
        Long transactionTypeId = transactionType.getId();

        // Get all the stockList where transactionType equals to transactionTypeId
        defaultStockShouldBeFound("transactionTypeId.equals=" + transactionTypeId);

        // Get all the stockList where transactionType equals to transactionTypeId + 1
        defaultStockShouldNotBeFound("transactionTypeId.equals=" + (transactionTypeId + 1));
    }
