...
public class InvoiceDetailsResourceIT {
    ...
    private static final String DEFAULT_INV_QTY = "AAAAAAAAAA";
    private static final String UPDATED_INV_QTY = "BBBBBBBBBB";
    ...
    public void getAllInvoiceDetails() throws Exception {
        ...
        restInvoiceDetailsMockMvc.perform(get("/api/invoice-details?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].invQty").value(hasItem(DEFAULT_INV_QTY)))
    ...
    public void getInvoiceDetails() throws Exception {
        ...
        restInvoiceDetailsMockMvc.perform(get("/api/invoice-details/{id}", invoiceDetails.getId()))
            ...
            .andExpect(jsonPath("$.invQty").value(DEFAULT_INV_QTY))
    ...
    public void getAllInvoiceDetailsByInvQtyIsNullOrNotNull() throws Exception {
        ...
        defaultInvoiceDetailsShouldNotBeFound("invQty.specified=false");
                ...
                @Test
    @Transactional
    public void getAllInvoiceDetailsByInvQtyContainsSomething() throws Exception {
        // Initialize the database
        invoiceDetailsRepository.saveAndFlush(invoiceDetails);

        // Get all the invoiceDetailsList where invQty contains DEFAULT_INV_QTY
        defaultInvoiceDetailsShouldBeFound("invQty.contains=" + DEFAULT_INV_QTY);

        // Get all the invoiceDetailsList where invQty contains UPDATED_INV_QTY
        defaultInvoiceDetailsShouldNotBeFound("invQty.contains=" + UPDATED_INV_QTY);
    }

    @Test
    @Transactional
    public void getAllInvoiceDetailsByInvQtyNotContainsSomething() throws Exception {
        // Initialize the database
        invoiceDetailsRepository.saveAndFlush(invoiceDetails);

        // Get all the invoiceDetailsList where invQty does not contain DEFAULT_INV_QTY
        defaultInvoiceDetailsShouldNotBeFound("invQty.doesNotContain=" + DEFAULT_INV_QTY);

        // Get all the invoiceDetailsList where invQty does not contain UPDATED_INV_QTY
        defaultInvoiceDetailsShouldBeFound("invQty.doesNotContain=" + UPDATED_INV_QTY);
    }
