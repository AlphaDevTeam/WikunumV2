...
export class ExpenseAccountService {
  ...
  protected convertDateFromClient(expenseAccount: IExpenseAccount): IExpenseAccount {
    const copy: IExpenseAccount = Object.assign({}, expenseAccount, {
      transactionDate:
        expenseAccount.transactionDate != null && expenseAccount.transactionDate.isValid()
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((expenseAccount: IExpenseAccount) => {
        expenseAccount.transactionDate = expenseAccount.transactionDate != null ? moment(expenseAccount.transactionDate) : null;
      });
    }
    return res;
  }
