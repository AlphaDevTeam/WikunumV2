...
public class CashPaymentVoucherSupplier implements Serializable {
    ...
    public CashPaymentVoucherSupplier transactionAmountDR(BigDecimal transactionAmountDR) {
    ...
    public CashPaymentVoucherSupplier transactionAmountCR(BigDecimal transactionAmountCR) {
